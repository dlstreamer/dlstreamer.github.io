...
* **Option 1** Downloading binaries:
  ...
  * Add path to ``bin`` folder into ``PATH`` environment variable
...
* **Option 2** Using MSYS2:
  ...
  * Add path to pkg-config into ``PATH`` environment variable
...
* https://gstreamer.freedesktop.org/data/pkg/windows/1.20.3/msvc/gstreamer-1.0-devel-msvc-x86_64-1.20.3.msi
...
Installation
Guide <https://docs.openvino.ai/latest/openvino_docs_install_guides_installing_openvino_windows_header.html>`__.
