.. index:: pair: class; dlstreamer::FFmpegFrame
.. _doxid-classdlstreamer_1_1_f_fmpeg_frame:
...
.. ref-code-block:: cpp
	...
	class FFmpegFrame: public :ref:`dlstreamer::BaseFrame<doxid-classdlstreamer_1_1_base_frame>` {
	public:
		// construction
	
		:target:`FFmpegFrame<doxid-classdlstreamer_1_1_f_fmpeg_frame_1a39285713aa62520dbe34d3270a67da87>`();
	
		:target:`FFmpegFrame<doxid-classdlstreamer_1_1_f_fmpeg_frame_1ab3a7f7a28a0fac1a646f4b698a04e3e4>`(
			AVFrame* frame,
			bool take_ownership = false,
			:ref:`ContextPtr<doxid-namespacedlstreamer_1a2eba287f35b2698b87aa6f560299ffe8>` context = nullptr
		);
	
		:target:`FFmpegFrame<doxid-classdlstreamer_1_1_f_fmpeg_frame_1a5ef5ebc97aacf2ee4ba4951040be0df1>`(
			const std::vector<AVFrame*>& batched_frames,
			bool take_ownership = false,
			:ref:`ContextPtr<doxid-namespacedlstreamer_1a2eba287f35b2698b87aa6f560299ffe8>` context = nullptr
		);
	
		:target:`FFmpegFrame<doxid-classdlstreamer_1_1_f_fmpeg_frame_1a01bf8375e254ccea76b34591345026d3>`(
			AVFrame* frame,
			bool take_ownership,
		...
		void :target:`init<doxid-classdlstreamer_1_1_f_fmpeg_frame_1aa313d079156d2d7abf012f9d36206bb6>`(
			const std::vector<AVFrame*>& frames,
			const :ref:`FrameInfo<doxid-structdlstreamer_1_1_frame_info>`& info,
			:ref:`ContextPtr<doxid-namespacedlstreamer_1a2eba287f35b2698b87aa6f560299ffe8>` context
		);
	
		AVFrame* :target:`avframe<doxid-classdlstreamer_1_1_f_fmpeg_frame_1a9ca337281fcbf9f0d129a49f967ae9c5>`();
	};
