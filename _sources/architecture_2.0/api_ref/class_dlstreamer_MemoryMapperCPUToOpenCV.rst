.. index:: pair: class; dlstreamer::MemoryMapperCPUToOpenCV
.. _doxid-classdlstreamer_1_1_memory_mapper_c_p_u_to_open_c_v:

class dlstreamer::MemoryMapperCPUToOpenCV
=========================================
...
.. ref-code-block:: cpp
	...
	#include <cpu_to_opencv.h>
	
	class MemoryMapperCPUToOpenCV: public :ref:`dlstreamer::BaseMemoryMapper<doxid-classdlstreamer_1_1_base_memory_mapper>` {
	public:
		// methods
	
		virtual :ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` :ref:`map<doxid-classdlstreamer_1_1_memory_mapper_c_p_u_to_open_c_v_1aa3b01fef128e4dfafc9a27ecd3c72f7b>`(:ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` src, :ref:`AccessMode<doxid-namespacedlstreamer_1a688aea01f1e852531b035128bbea9e10>` mode);
	
		:target:`BaseMemoryMapper<doxid-classdlstreamer_1_1_memory_mapper_c_p_u_to_open_c_v_1a77d79fd0e116dfb03beed2bcdbf60830>`(
...
.. _details-classdlstreamer_1_1_memory_mapper_c_p_u_to_open_c_v:
...
.. _doxid-classdlstreamer_1_1_memory_mapper_c_p_u_to_open_c_v_1aa3b01fef128e4dfafc9a27ecd3c72f7b:
