.. index:: pair: class; dlstreamer::MemoryMapperAnyToGST
.. _doxid-classdlstreamer_1_1_memory_mapper_any_to_g_s_t:

class dlstreamer::MemoryMapperAnyToGST
======================================
...
.. ref-code-block:: cpp
	...
	#include <any_to_gst.h>
	
	class MemoryMapperAnyToGST: public :ref:`dlstreamer::BaseMemoryMapper<doxid-classdlstreamer_1_1_base_memory_mapper>` {
	public:
		// construction
	
		:target:`MemoryMapperAnyToGST<doxid-classdlstreamer_1_1_memory_mapper_any_to_g_s_t_1a34f9de2c79b005655678c3b44242a339>`(
		...
		virtual :ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` :ref:`map<doxid-classdlstreamer_1_1_memory_mapper_any_to_g_s_t_1a589c77a39fff08d6149812602a6a2cfe>`(:ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` src, :ref:`AccessMode<doxid-namespacedlstreamer_1a688aea01f1e852531b035128bbea9e10>` mode);
		virtual :ref:`FramePtr<doxid-classdlstreamer_1_1_frame_ptr>` :ref:`map<doxid-classdlstreamer_1_1_memory_mapper_any_to_g_s_t_1af6317f328db4999fefe2833d8301c276>`(:ref:`FramePtr<doxid-classdlstreamer_1_1_frame_ptr>` src, :ref:`AccessMode<doxid-namespacedlstreamer_1a688aea01f1e852531b035128bbea9e10>` mode);
	
		:target:`BaseMemoryMapper<doxid-classdlstreamer_1_1_memory_mapper_any_to_g_s_t_1a77d79fd0e116dfb03beed2bcdbf60830>`(
			const :ref:`ContextPtr<doxid-namespacedlstreamer_1a2eba287f35b2698b87aa6f560299ffe8>`& input_context,
			const :ref:`ContextPtr<doxid-namespacedlstreamer_1a2eba287f35b2698b87aa6f560299ffe8>`& output_context
		);
	};
...
.. _details-classdlstreamer_1_1_memory_mapper_any_to_g_s_t:
...
.. _doxid-classdlstreamer_1_1_memory_mapper_any_to_g_s_t_1a589c77a39fff08d6149812602a6a2cfe:
...
.. index:: pair: function; map
.. _doxid-classdlstreamer_1_1_memory_mapper_any_to_g_s_t_1af6317f328db4999fefe2833d8301c276:
