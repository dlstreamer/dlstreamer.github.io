.. index:: pair: class; dlstreamer::CPUTensor
.. _doxid-classdlstreamer_1_1_c_p_u_tensor:

class dlstreamer::CPUTensor
===========================
...
.. ref-code-block:: cpp
	...
	class CPUTensor: public :ref:`dlstreamer::BaseTensor<doxid-classdlstreamer_1_1_base_tensor>` {
	public:
		// construction
	
		:target:`CPUTensor<doxid-classdlstreamer_1_1_c_p_u_tensor_1a04b01f9beff9a6736e9607f3e4330484>`(const :ref:`TensorInfo<doxid-structdlstreamer_1_1_tensor_info>`& info, void* data);

		// methods
	
		virtual void* :ref:`data<doxid-classdlstreamer_1_1_c_p_u_tensor_1a62a37b122d0150cc90b9040aa67037ef>`() const;
	};
...
.. _details-classdlstreamer_1_1_c_p_u_tensor:
...
.. _doxid-classdlstreamer_1_1_c_p_u_tensor_1a62a37b122d0150cc90b9040aa67037ef:
