.. index:: pair: class; dlstreamer::SYCLContext
.. _doxid-classdlstreamer_1_1_s_y_c_l_context:
...
.. toctree::
	...
	struct_dlstreamer_SYCLContext_key.rst
...
.. ref-code-block:: cpp
	...
	class SYCLContext: public :ref:`dlstreamer::LevelZeroContext<doxid-classdlstreamer_1_1_level_zero_context>` {
	public:
		// structs
	
		struct :ref:`key<doxid-structdlstreamer_1_1_s_y_c_l_context_1_1key>`;

		// construction
	
		:target:`SYCLContext<doxid-classdlstreamer_1_1_s_y_c_l_context_1a7cebf3a9b00092e7042d963c83b975a0>`(sycl::queue sycl_queue);

		// methods
	
		static :ref:`SYCLContextPtr<doxid-namespacedlstreamer_1aab4aa06a967a45db7a9a782cdcdaa8cd>` :target:`create<doxid-classdlstreamer_1_1_s_y_c_l_context_1a389954085a1e7b4fb041003a7280d527>`(sycl::queue sycl_queue);
		sycl::queue :target:`sycl_queue<doxid-classdlstreamer_1_1_s_y_c_l_context_1a0f728a7deed550371dd1d24d9c97384b>`() const;
		virtual :ref:`handle_t<doxid-classdlstreamer_1_1_context_1aca2855e33d7c60441af838d51fea6bbb>` :ref:`handle<doxid-classdlstreamer_1_1_s_y_c_l_context_1aa13d738a94482a499c013f6c7261c9db>`(std::string_view key) const;
		virtual std::vector<std::string> :target:`keys<doxid-classdlstreamer_1_1_s_y_c_l_context_1a1321f0f2ae02f6e4d604817d7bca38de>`() const;
	
		virtual :ref:`MemoryMapperPtr<doxid-namespacedlstreamer_1a6e9a7ff17b4ff02042f7ad6784323f10>` :ref:`get_mapper<doxid-classdlstreamer_1_1_s_y_c_l_context_1a2eb170c85a167d0a623ee2e335e27044>`(
		...
		template <typename T>
		T* :target:`malloc<doxid-classdlstreamer_1_1_s_y_c_l_context_1a91c553796769beff2450394b78b3b75d>`(size_t count, sycl::usm::alloc kind);
	
		template <typename T>
		void :target:`free<doxid-classdlstreamer_1_1_s_y_c_l_context_1ac666aef13fe3eaf49e9f10c57ce760ae>`(T* ptr);
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		ze_context_handle_t :ref:`ze_context<doxid-classdlstreamer_1_1_level_zero_context_1ad3941f1d018090c6659cc82528871a18>`() const;
		ze_device_handle_t :ref:`ze_device<doxid-classdlstreamer_1_1_level_zero_context_1ad0711fe276f3e76f150916154f487d92>`() const;
		...
		virtual std::vector<std::string> :ref:`keys<doxid-classdlstreamer_1_1_level_zero_context_1ab2a21fb3794886f76bbebb4c6ab8381e>`() const;
...
.. _details-classdlstreamer_1_1_s_y_c_l_context:
...
.. _doxid-classdlstreamer_1_1_s_y_c_l_context_1aa13d738a94482a499c013f6c7261c9db:
...
.. _doxid-classdlstreamer_1_1_s_y_c_l_context_1a2eb170c85a167d0a623ee2e335e27044:
