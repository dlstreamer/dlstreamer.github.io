.. index:: pair: class; dlstreamer::VAAPIFrameAlloc
.. _doxid-classdlstreamer_1_1_v_a_a_p_i_frame_alloc:

class dlstreamer::VAAPIFrameAlloc
=================================
...
.. ref-code-block:: cpp
	...
	class VAAPIFrameAlloc: public :ref:`dlstreamer::VAAPIFrame<doxid-classdlstreamer_1_1_v_a_a_p_i_frame>` {
	public:
		// construction
	
		:target:`VAAPIFrameAlloc<doxid-classdlstreamer_1_1_v_a_a_p_i_frame_alloc_1ae62ad84e2a18a6e5332632e6b00c55b0>`(const :ref:`FrameInfo<doxid-structdlstreamer_1_1_frame_info>`& info, :ref:`ContextPtr<doxid-namespacedlstreamer_1a2eba287f35b2698b87aa6f560299ffe8>` context);
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		:ref:`VAAPITensor::VASurfaceID<doxid-classdlstreamer_1_1_v_a_a_p_i_tensor_1a6d32fb46cdfeadee14101662fbb53118>` :ref:`va_surface<doxid-classdlstreamer_1_1_v_a_a_p_i_frame_1a350a0242a395af0cb583bfa0fe95a6bd>`(int plane_index = 0);
