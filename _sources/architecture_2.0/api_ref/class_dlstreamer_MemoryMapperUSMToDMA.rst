.. index:: pair: class; dlstreamer::MemoryMapperUSMToDMA
.. _doxid-classdlstreamer_1_1_memory_mapper_u_s_m_to_d_m_a:

class dlstreamer::MemoryMapperUSMToDMA
======================================
...
.. ref-code-block:: cpp
	...
	#include <usm_to_dma.h>
	
	class MemoryMapperUSMToDMA: public :ref:`dlstreamer::BaseMemoryMapper<doxid-classdlstreamer_1_1_base_memory_mapper>` {
	public:
		// construction
	
		:target:`MemoryMapperUSMToDMA<doxid-classdlstreamer_1_1_memory_mapper_u_s_m_to_d_m_a_1a6d9fd1581d6d5bb3baa3defe03402a51>`(
		...
		virtual :ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` :ref:`map<doxid-classdlstreamer_1_1_memory_mapper_u_s_m_to_d_m_a_1a387648ee09a24b7726af25d2f5378c1e>`(:ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` src, :ref:`AccessMode<doxid-namespacedlstreamer_1a688aea01f1e852531b035128bbea9e10>` mode);
	};
...
.. _details-classdlstreamer_1_1_memory_mapper_u_s_m_to_d_m_a:
...
.. _doxid-classdlstreamer_1_1_memory_mapper_u_s_m_to_d_m_a_1a387648ee09a24b7726af25d2f5378c1e:
