.. index:: pair: class; dlstreamer::MemoryMapperVAAPIToDMA
.. _doxid-classdlstreamer_1_1_memory_mapper_v_a_a_p_i_to_d_m_a:

class dlstreamer::MemoryMapperVAAPIToDMA
========================================
...
.. ref-code-block:: cpp
	...
	#include <vaapi_to_dma.h>
	
	class MemoryMapperVAAPIToDMA: public :ref:`dlstreamer::BaseMemoryMapper<doxid-classdlstreamer_1_1_base_memory_mapper>` {
	public:
		// construction
	
		:target:`MemoryMapperVAAPIToDMA<doxid-classdlstreamer_1_1_memory_mapper_v_a_a_p_i_to_d_m_a_1a1096a9245f3325f3ccaebdff2d135c81>`(
		...
		virtual :ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` :ref:`map<doxid-classdlstreamer_1_1_memory_mapper_v_a_a_p_i_to_d_m_a_1ae7eec79817ac7a0dfdc481b24d831a74>`(:ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` src, :ref:`AccessMode<doxid-namespacedlstreamer_1a688aea01f1e852531b035128bbea9e10>` mode);
		virtual :ref:`FramePtr<doxid-classdlstreamer_1_1_frame_ptr>` :ref:`map<doxid-classdlstreamer_1_1_memory_mapper_v_a_a_p_i_to_d_m_a_1a214b949564b58b425bd7e148e5a94d45>`(:ref:`FramePtr<doxid-classdlstreamer_1_1_frame_ptr>` src, :ref:`AccessMode<doxid-namespacedlstreamer_1a688aea01f1e852531b035128bbea9e10>` mode);
	};
...
.. _details-classdlstreamer_1_1_memory_mapper_v_a_a_p_i_to_d_m_a:
...
.. _doxid-classdlstreamer_1_1_memory_mapper_v_a_a_p_i_to_d_m_a_1ae7eec79817ac7a0dfdc481b24d831a74:
...
.. index:: pair: function; map
.. _doxid-classdlstreamer_1_1_memory_mapper_v_a_a_p_i_to_d_m_a_1a214b949564b58b425bd7e148e5a94d45:
