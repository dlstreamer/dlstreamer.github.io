.. index:: pair: class; dlstreamer::MemoryMapperOpenCLToOpenCVUMat
.. _doxid-classdlstreamer_1_1_memory_mapper_open_c_l_to_open_c_v_u_mat:

class dlstreamer::MemoryMapperOpenCLToOpenCVUMat
================================================
...
.. ref-code-block:: cpp
	...
	#include <opencl_to_opencv_umat.h>
	
	class MemoryMapperOpenCLToOpenCVUMat: public :ref:`dlstreamer::BaseMemoryMapper<doxid-classdlstreamer_1_1_base_memory_mapper>` {
	public:
		// methods
	
		virtual :ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` :ref:`map<doxid-classdlstreamer_1_1_memory_mapper_open_c_l_to_open_c_v_u_mat_1a56e0fda7656fd755f32e08caa11d0290>`(:ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` src, :ref:`AccessMode<doxid-namespacedlstreamer_1a688aea01f1e852531b035128bbea9e10>` mode);
	
		:target:`BaseMemoryMapper<doxid-classdlstreamer_1_1_memory_mapper_open_c_l_to_open_c_v_u_mat_1a77d79fd0e116dfb03beed2bcdbf60830>`(
...
.. _details-classdlstreamer_1_1_memory_mapper_open_c_l_to_open_c_v_u_mat:
...
.. _doxid-classdlstreamer_1_1_memory_mapper_open_c_l_to_open_c_v_u_mat_1a56e0fda7656fd755f32e08caa11d0290:
