.. index:: pair: class; dlstreamer::MemoryMapperDMAToOpenCL
.. _doxid-classdlstreamer_1_1_memory_mapper_d_m_a_to_open_c_l:

class dlstreamer::MemoryMapperDMAToOpenCL
=========================================
...
.. ref-code-block:: cpp
	...
	#include <dma_to_opencl.h>
	
	class MemoryMapperDMAToOpenCL: public :ref:`dlstreamer::BaseMemoryMapper<doxid-classdlstreamer_1_1_base_memory_mapper>` {
	public:
		// construction
	
		:target:`MemoryMapperDMAToOpenCL<doxid-classdlstreamer_1_1_memory_mapper_d_m_a_to_open_c_l_1a0dd2cd05908060639e38b57759c07203>`(
		...
		virtual :ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` :ref:`map<doxid-classdlstreamer_1_1_memory_mapper_d_m_a_to_open_c_l_1ae82424cd45030c50a1bb1a0d05998029>`(:ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` src, :ref:`AccessMode<doxid-namespacedlstreamer_1a688aea01f1e852531b035128bbea9e10>` mode);
	};
...
.. _details-classdlstreamer_1_1_memory_mapper_d_m_a_to_open_c_l:
...
.. _doxid-classdlstreamer_1_1_memory_mapper_d_m_a_to_open_c_l_1ae82424cd45030c50a1bb1a0d05998029:
