.. index:: pair: class; dlstreamer::MemoryMapperOpenCLToOpenVINO
.. _doxid-classdlstreamer_1_1_memory_mapper_open_c_l_to_open_v_i_n_o:

class dlstreamer::MemoryMapperOpenCLToOpenVINO
==============================================
...
.. ref-code-block:: cpp
	...
	#include <opencl_to_openvino.h>
	
	class MemoryMapperOpenCLToOpenVINO: public :ref:`dlstreamer::BaseMemoryMapper<doxid-classdlstreamer_1_1_base_memory_mapper>` {
	public:
		// construction
	
		:target:`MemoryMapperOpenCLToOpenVINO<doxid-classdlstreamer_1_1_memory_mapper_open_c_l_to_open_v_i_n_o_1a38f9f7d55f60b63425743f4e41451db4>`(
		...
		virtual :ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` :ref:`map<doxid-classdlstreamer_1_1_memory_mapper_open_c_l_to_open_v_i_n_o_1a96aede7a43115bac5822ba93ff5e8e64>`(:ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` src, :ref:`AccessMode<doxid-namespacedlstreamer_1a688aea01f1e852531b035128bbea9e10>` mode);
	};
...
.. _details-classdlstreamer_1_1_memory_mapper_open_c_l_to_open_v_i_n_o:
...
.. _doxid-classdlstreamer_1_1_memory_mapper_open_c_l_to_open_v_i_n_o_1a96aede7a43115bac5822ba93ff5e8e64:
