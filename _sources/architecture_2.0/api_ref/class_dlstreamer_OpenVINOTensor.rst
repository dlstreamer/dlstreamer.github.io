.. index:: pair: class; dlstreamer::OpenVINOTensor
.. _doxid-classdlstreamer_1_1_open_v_i_n_o_tensor:

class dlstreamer::OpenVINOTensor
================================
...
.. ref-code-block:: cpp
	...
	class OpenVINOTensor: public :ref:`dlstreamer::BaseTensor<doxid-classdlstreamer_1_1_base_tensor>` {
	public:
		// construction
	
		:target:`OpenVINOTensor<doxid-classdlstreamer_1_1_open_v_i_n_o_tensor_1a4a63a40f11036a10151b5372006b18e5>`(
			ov::Tensor tensor,
			:ref:`ContextPtr<doxid-namespacedlstreamer_1a2eba287f35b2698b87aa6f560299ffe8>` context,
			std::function<void()> wait_function = nullptr
		);

		// methods
	
		virtual void* :ref:`data<doxid-classdlstreamer_1_1_open_v_i_n_o_tensor_1ad806a0a24bab5386164427c3be6ca7ae>`() const;
		ov::Tensor :target:`ov_tensor<doxid-classdlstreamer_1_1_open_v_i_n_o_tensor_1a6fb80d2bc6af5c9b71f201b8665a29b5>`() const;
		:target:`operator ov::Tensor<doxid-classdlstreamer_1_1_open_v_i_n_o_tensor_1a2aac498638aaffae95e6609e972831a3>` () const;
	};
...
.. _details-classdlstreamer_1_1_open_v_i_n_o_tensor:
...
.. _doxid-classdlstreamer_1_1_open_v_i_n_o_tensor_1ad806a0a24bab5386164427c3be6ca7ae:
