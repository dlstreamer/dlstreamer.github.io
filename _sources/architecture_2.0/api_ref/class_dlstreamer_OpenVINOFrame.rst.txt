.. index:: pair: class; dlstreamer::OpenVINOFrame
.. _doxid-classdlstreamer_1_1_open_v_i_n_o_frame:

class dlstreamer::OpenVINOFrame
===============================
...
.. ref-code-block:: cpp
	...
	class OpenVINOFrame: public :ref:`dlstreamer::BaseFrame<doxid-classdlstreamer_1_1_base_frame>` {
	public:
		// construction
	
		:target:`OpenVINOFrame<doxid-classdlstreamer_1_1_open_v_i_n_o_frame_1a448d60351b05f90a26dc546f5b2598e2>`(ov::InferRequest infer_request, :ref:`ContextPtr<doxid-namespacedlstreamer_1a2eba287f35b2698b87aa6f560299ffe8>` context);

		// methods
	
		:target:`operator ov::InferRequest<doxid-classdlstreamer_1_1_open_v_i_n_o_frame_1a7bd485a684d45c02e6259a216b6db3f6>` ();
		void :target:`set_input<doxid-classdlstreamer_1_1_open_v_i_n_o_frame_1a46807fa36ebfa31bd61b2bdf7f75c269>`(:ref:`TensorVector<doxid-namespacedlstreamer_1aef57279f206868573faca2d977200ea9>` tensors);
		void :target:`start<doxid-classdlstreamer_1_1_open_v_i_n_o_frame_1ad139930a53b85429950ff2ec461fa6cc>`();
		void :target:`wait<doxid-classdlstreamer_1_1_open_v_i_n_o_frame_1ad7e2f01af71ec70242816d05d5f300c4>`();
	};
