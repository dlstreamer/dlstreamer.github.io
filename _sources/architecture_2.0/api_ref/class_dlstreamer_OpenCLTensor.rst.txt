.. index:: pair: class; dlstreamer::OpenCLTensor
.. _doxid-classdlstreamer_1_1_open_c_l_tensor:

class dlstreamer::OpenCLTensor
==============================
...
.. ref-code-block:: cpp
	...
	class OpenCLTensor: public :ref:`dlstreamer::BaseTensor<doxid-classdlstreamer_1_1_base_tensor>` {
	public:
		// construction
	
		:target:`OpenCLTensor<doxid-classdlstreamer_1_1_open_c_l_tensor_1a58eaba690a2ca91d675bd62c0d531c28>`(const :ref:`TensorInfo<doxid-structdlstreamer_1_1_tensor_info>`& info, :ref:`ContextPtr<doxid-namespacedlstreamer_1a2eba287f35b2698b87aa6f560299ffe8>` context, :ref:`cl_mem<doxid-opencl_2tensor_8h_1af2141916ad9655073b9810d7bc71494d>` mem);

		// methods
	
		:ref:`cl_mem<doxid-opencl_2tensor_8h_1af2141916ad9655073b9810d7bc71494d>` :target:`clmem<doxid-classdlstreamer_1_1_open_c_l_tensor_1a5bdbec35b284b324854cf1219c5be9d7>`() const;
		:target:`operator cl_mem<doxid-classdlstreamer_1_1_open_c_l_tensor_1a7f3ccc5991a4e6b4a246a36d4b97a6c4>` () const;
		size_t :target:`offset<doxid-classdlstreamer_1_1_open_c_l_tensor_1a53dc5ea4368f6f04c8a0516344f204c7>`() const;
	};
