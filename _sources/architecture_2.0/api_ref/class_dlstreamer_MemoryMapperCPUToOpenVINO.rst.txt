.. index:: pair: class; dlstreamer::MemoryMapperCPUToOpenVINO
.. _doxid-classdlstreamer_1_1_memory_mapper_c_p_u_to_open_v_i_n_o:

class dlstreamer::MemoryMapperCPUToOpenVINO
===========================================
...
.. ref-code-block:: cpp
	...
	#include <cpu_to_openvino.h>
	
	class MemoryMapperCPUToOpenVINO: public :ref:`dlstreamer::BaseMemoryMapper<doxid-classdlstreamer_1_1_base_memory_mapper>` {
	public:
		// methods
	
		virtual :ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` :ref:`map<doxid-classdlstreamer_1_1_memory_mapper_c_p_u_to_open_v_i_n_o_1a7872a3f36b5d62f550759450a17a2d32>`(:ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` src, :ref:`AccessMode<doxid-namespacedlstreamer_1a688aea01f1e852531b035128bbea9e10>` mode);
		virtual :ref:`FramePtr<doxid-classdlstreamer_1_1_frame_ptr>` :ref:`map<doxid-classdlstreamer_1_1_memory_mapper_c_p_u_to_open_v_i_n_o_1a03f82a53d77b6482254d88387745d033>`(:ref:`FramePtr<doxid-classdlstreamer_1_1_frame_ptr>` src, :ref:`AccessMode<doxid-namespacedlstreamer_1a688aea01f1e852531b035128bbea9e10>` mode);
	
		:target:`BaseMemoryMapper<doxid-classdlstreamer_1_1_memory_mapper_c_p_u_to_open_v_i_n_o_1a77d79fd0e116dfb03beed2bcdbf60830>`(
...
.. _details-classdlstreamer_1_1_memory_mapper_c_p_u_to_open_v_i_n_o:
...
.. _doxid-classdlstreamer_1_1_memory_mapper_c_p_u_to_open_v_i_n_o_1a7872a3f36b5d62f550759450a17a2d32:
...
.. index:: pair: function; map
.. _doxid-classdlstreamer_1_1_memory_mapper_c_p_u_to_open_v_i_n_o_1a03f82a53d77b6482254d88387745d033:
