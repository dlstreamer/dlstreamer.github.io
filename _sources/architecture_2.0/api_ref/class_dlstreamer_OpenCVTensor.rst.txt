.. index:: pair: class; dlstreamer::OpenCVTensor
.. _doxid-classdlstreamer_1_1_open_c_v_tensor:

class dlstreamer::OpenCVTensor
==============================
...
.. ref-code-block:: cpp
	...
	class OpenCVTensor: public :ref:`dlstreamer::BaseTensor<doxid-classdlstreamer_1_1_base_tensor>` {
	public:
		// construction
	
		:target:`OpenCVTensor<doxid-classdlstreamer_1_1_open_c_v_tensor_1ab9c663807d6bbb1e6fdf730b56de0f8b>`(const cv::Mat& mat, const :ref:`TensorInfo<doxid-structdlstreamer_1_1_tensor_info>`& info);
		:target:`OpenCVTensor<doxid-classdlstreamer_1_1_open_c_v_tensor_1a6131449e5ecc70d31aec6c73fe0fa553>`(const cv::Mat& mat);

		// methods
	
		:target:`operator cv::Mat<doxid-classdlstreamer_1_1_open_c_v_tensor_1acf235340dd4f5e70780e32b5fa9598b3>` () const;
		cv::Mat :target:`cv_mat<doxid-classdlstreamer_1_1_open_c_v_tensor_1a7ec866adf96cc777a3821bf9ae1fa2d4>`() const;
		virtual void* :ref:`data<doxid-classdlstreamer_1_1_open_c_v_tensor_1ad6378305278a386ba85328fb71b35b69>`() const;
	};
...
.. _details-classdlstreamer_1_1_open_c_v_tensor:
...
.. _doxid-classdlstreamer_1_1_open_c_v_tensor_1ad6378305278a386ba85328fb71b35b69:
