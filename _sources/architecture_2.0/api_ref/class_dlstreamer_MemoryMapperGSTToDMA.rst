.. index:: pair: class; dlstreamer::MemoryMapperGSTToDMA
.. _doxid-classdlstreamer_1_1_memory_mapper_g_s_t_to_d_m_a:

class dlstreamer::MemoryMapperGSTToDMA
======================================
...
.. ref-code-block:: cpp
	...
	#include <gst_to_dma.h>
	
	class MemoryMapperGSTToDMA: public :ref:`dlstreamer::BaseMemoryMapper<doxid-classdlstreamer_1_1_base_memory_mapper>` {
	public:
		// methods
	
		virtual :ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` :ref:`map<doxid-classdlstreamer_1_1_memory_mapper_g_s_t_to_d_m_a_1aea5e2b9c5b237313123bbf5af537aed1>`(:ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` src, :ref:`AccessMode<doxid-namespacedlstreamer_1a688aea01f1e852531b035128bbea9e10>` mode);
	
		:target:`BaseMemoryMapper<doxid-classdlstreamer_1_1_memory_mapper_g_s_t_to_d_m_a_1a77d79fd0e116dfb03beed2bcdbf60830>`(
...
.. _details-classdlstreamer_1_1_memory_mapper_g_s_t_to_d_m_a:
...
.. _doxid-classdlstreamer_1_1_memory_mapper_g_s_t_to_d_m_a_1aea5e2b9c5b237313123bbf5af537aed1:
