.. index:: pair: class; dlstreamer::DMATensor
.. _doxid-classdlstreamer_1_1_d_m_a_tensor:

class dlstreamer::DMATensor
===========================
...
.. ref-code-block:: cpp
	...
	class DMATensor: public :ref:`dlstreamer::BaseTensor<doxid-classdlstreamer_1_1_base_tensor>` {
	public:
		// construction
	
		:target:`DMATensor<doxid-classdlstreamer_1_1_d_m_a_tensor_1a1d8a3f5746b84d9ace439a6d8c7d11d6>`(
			int dma_fd,
			int drm_modifier,
		...
		int :target:`dma_fd<doxid-classdlstreamer_1_1_d_m_a_tensor_1a9baee37f0f5c7ce5aa43a755fdd29244>`() const;
		int :target:`drm_modifier<doxid-classdlstreamer_1_1_d_m_a_tensor_1a2782378d6dd745ebcff3a1df65d3ab5a>`() const;
		size_t :target:`offset<doxid-classdlstreamer_1_1_d_m_a_tensor_1ac1dcd8757b6b4ad9c72a1af2021b86b0>`() const;
	};
