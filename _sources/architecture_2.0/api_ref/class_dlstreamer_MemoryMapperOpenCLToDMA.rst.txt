.. index:: pair: class; dlstreamer::MemoryMapperOpenCLToDMA
.. _doxid-classdlstreamer_1_1_memory_mapper_open_c_l_to_d_m_a:

class dlstreamer::MemoryMapperOpenCLToDMA
=========================================
...
.. ref-code-block:: cpp
	...
	#include <opencl_to_dma.h>
	
	class MemoryMapperOpenCLToDMA: public :ref:`dlstreamer::BaseMemoryMapper<doxid-classdlstreamer_1_1_base_memory_mapper>` {
	public:
		// methods
	
		virtual :ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` :ref:`map<doxid-classdlstreamer_1_1_memory_mapper_open_c_l_to_d_m_a_1a5d32b05c50a78f3b287b676bfdd9fcac>`(:ref:`TensorPtr<doxid-classdlstreamer_1_1_tensor_ptr>` src, :ref:`AccessMode<doxid-namespacedlstreamer_1a688aea01f1e852531b035128bbea9e10>` mode);
	
		:target:`BaseMemoryMapper<doxid-classdlstreamer_1_1_memory_mapper_open_c_l_to_d_m_a_1a77d79fd0e116dfb03beed2bcdbf60830>`(
...
.. _details-classdlstreamer_1_1_memory_mapper_open_c_l_to_d_m_a:
...
.. _doxid-classdlstreamer_1_1_memory_mapper_open_c_l_to_d_m_a_1a5d32b05c50a78f3b287b676bfdd9fcac:
